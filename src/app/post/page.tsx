...
export default function PostJobPage() {
  ...
  return (
    <AppShell>
      <div className="mb-4">
        <h1 className="text-xl font-semibold text-navy-900">Post a job</h1>
        <p className="text-xs text-navy-400">Share a role with the Policy Bootcamp network.</p>
      </div>
      ...
      <Card><div className="p-5">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <Button type="submit" loading={submitting} className="flex-1">Publish job</Button>
          </div>
        </form>
      </div></Card>
    </AppShell>
